...
const MarketCardSlider = () =>{
    return(
        <>
            <Swiper className="swiper overflow-hidden"						
				speed= {1500}
				slidesPerView= {4}
				spaceBetween= {20}
				loop={false}
                    ...
                    <div className="card card-box">
                        <div className="card-body">
                            ...
                            <div className="d-block">
                                ...
                                <span className="fs-14 font-w500 text-danger"><i className="bi bi-caret-down-fill pe-2"></i>+ 2.0%</span>
                            </div>
                        </div>	                        
                    </div>                   
				</SwiperSlide>
